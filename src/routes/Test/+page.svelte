...
<script>
  ...
  let { children } = $props();
    ...
    var m = $state(M([ ["blue", "blue", "blue", "blue", "blue", "blue", "blue", "blue", "blue"], ["green", "green", "green", "green", "green", "green", "green", "green", "green"], ["red", "red", "red", "red", "red", "red", "red", "red", "red"], ["orange", "orange", "orange", "orange", "orange", "orange", "orange", "orange", "orange"], ["yellow", "yellow", "yellow", "yellow", "yellow", "yellow", "yellow", "yellow", "yellow"], ["white", "white", "white", "white", "white", "white", "white", "white", "white"] ]));
    ...
    let Sally = $derived(m(dF3ar).length);
      ...
      <div class="container">
          <div class={cu}>
              <div class="face front">
                  <div class="grid">
                      <button style="background-color: {m(dF3x)[3][0]}" onclick={() => {m(Fz)}}></button>
                      <button style="background-color: {m(dF3x)[3][1]}" onclick={() => {m(Cx)}}></button>
                      <button style="background-color: {m(dF3x)[3][2]}" onclick={() => {m(F)}}></button>
                      <button style="background-color: {m(dF3x)[3][3]}" onclick={() => {m(Cyr)}}></button>
                      <button style="background-color: {m(dF3x)[3][4]}" onclick={() => {m(Zro)}}></button>
                      <button style="background-color: {m(dF3x)[3][5]}" onclick={() => {m(Cy)}}></button>
                      <button style="background-color: {m(dF3x)[3][6]}" onclick={() => {m(Fz)}}></button>
                      <button style="background-color: {m(dF3x)[3][7]}" onclick={() => {m(Cxr)}}></button>
                      <button style="background-color: {m(dF3x)[3][8]}" onclick={() => {m(F)}}></button>
                  </div>
              </div>
  
              <div class="face right">
                  <div class="grid">
                      <button style="background-color: {m(dF3x)[0][0]}" onclick={() => {m(Rz)}}></button>
                      <button style="background-color: {m(dF3x)[0][1]}" onclick={() => {m(Cz)}}></button>
                      <button style="background-color: {m(dF3x)[0][2]}" onclick={() => {m(R)}}></button>
                      <button style="background-color: {m(dF3x)[0][3]}" onclick={() => {m(Cyr)}}></button>
                      <button style="background-color: {m(dF3x)[0][4]}" onclick={() => {m(Xro)}}></button>
                      <button style="background-color: {m(dF3x)[0][5]}" onclick={() => {m(Cy)}}></button>
                      <button style="background-color: {m(dF3x)[0][6]}" onclick={() => {m(Rz)}}></button>
                      <button style="background-color: {m(dF3x)[0][7]}" onclick={() => {m(Czr)}}></button>
                      <button style="background-color: {m(dF3x)[0][8]}" onclick={() => {m(R)}}></button>
                  </div>
              </div>
              <div class="face top">
                  <div class="grid">
                      <button style="background-color: {m(dF3x)[4][0]}" onclick={() => {m(Uz)}}></button>
                      <button style="background-color: {m(dF3x)[4][1]}" onclick={() => {m(Cx)}}></button>
                      <button style="background-color: {m(dF3x)[4][2]}" onclick={() => {m(U)}}></button>
                      <button style="background-color: {m(dF3x)[4][3]}" onclick={() => {m(Cz)}}></button>
                      <button style="background-color: {m(dF3x)[4][4]}" onclick={() => {m(Yro)}}></button>
                      <button style="background-color: {m(dF3x)[4][5]}" onclick={() => {m(Czr)}}></button>
                      <button style="background-color: {m(dF3x)[4][6]}" onclick={() => {m(Uz)}}></button>
                      <button style="background-color: {m(dF3x)[4][7]}" onclick={() => {m(Cxr)}}></button>
                      <button style="background-color: {m(dF3x)[4][8]}" onclick={() => {m(U)}}></button>
                  </div>        
              </div>        
                    </div>
